...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        notificationRepository.save(new Notification(
                "farmer_john",
                "Application SUB-2026-PN001 Submitted",
                "Your application for PM Kisan Drone Subsidy Scheme was successfully registered in Maharashtra Region.",
        ...
        notificationRepository.save(new Notification(
                ...
                "Officer Amit Kumar conducted physical verification for application SUB-2026-PN001. Land records verified.",
        ...
        notificationRepository.save(new Notification(
                ...
                "First DBT tranche of INR 50,000 credited to bank account for application SUB-2026-PN002. Treasury UTR: UTR202609018872341.",
                NotificationType.DISBURSEMENT_RELEASED,
                "SubsidyApplication",
                app2.getId(),
                "/beneficiary/applications/" + app2.getId()
        ));

        notificationRepository.save(new Notification(
                "field_officer1",
                "Pending Field Inspections",
                "Application SUB-2026-PN003 has passed automated scoring and is awaiting physical ground verification.",
                NotificationType.APPLICATION_STATUS_UPDATE,
                "SubsidyApplication",
                app3.getId(),
