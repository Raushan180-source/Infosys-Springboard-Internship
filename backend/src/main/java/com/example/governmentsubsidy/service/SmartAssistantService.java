...
public class SmartAssistantService {
    ...
    private AssistantResponse handleEligibilityQuery(String query, Optional<Beneficiary> beneficiaryOpt) {
        ...
        if (beneficiaryOpt.isPresent()) {
            ...
            sb.append("Based on your verified beneficiary profile (Income: ₹").append(b.getAnnualIncome())
            ...
            for (SchemeRecommendationResponse rec : recommendations) {
                String badge = "STRONG".equals(rec.getMatchLevel()) ? "🟢 High Match" : ("MODERATE".equals(rec.getMatchLevel()) ? "🟡 Moderate Match" : "⚪ Low Match");
            ...
            sb.append("\nOur rule engine matches your income, category, land holding, and region against each scheme's criteria before submission.");
    ...
    private AssistantResponse handleGeneralHelp(User currentUser, Optional<Beneficiary> beneficiaryOpt) {
        ...
        String ans = greeting + "I am your Government Subsidy & Grant Information Assistant.\n\n" +
